...
class snow_upcoming_workshops_sticky {

/* Begin extending widget for Upcoming Workshops front panel */
	function snow_upcoming_workshops_sticky( $category = 7, $posts = 1, $ignore = 1 ) { 
	 
		/* Get all Upcoming Workshop sticky notes */
		$sticky = array(
		  'category__and' => $category, // Change to prod category ID
...
function snow_feature_article_sticky() { 
 
	/* Get all Upcoming Workshop sticky notes */
	$sticky = array(
	  'category__and' => 9, // Change to prod category ID
	  'posts_per_page' => 1,
	  'post__in' => get_option( 'sticky_posts' ),
...
add_shortcode('snow_feature_article_sticky', 'snow_feature_article_sticky');

function snow_featured_content_sticky() { 
 
	/* Get all Upcoming Workshop sticky notes */
	$sticky = array(
	  'category__and' => 4, // Change to prod category ID
	  'posts_per_page' => 1,
	  'post__in' => get_option( 'sticky_posts' ),
	  'ignore_sticky_posts' => 1
	);
...
add_shortcode('snow_featured_content_sticky', 'snow_featured_content_sticky');
...
class snow_feature_article extends snow_upcoming_workshops {
  ...
  public function widget( $args ) {
    ...
    $content = do_shortcode('[snow_feature_article_sticky]');
...
class snow_featured_content extends snow_upcoming_workshops {
  ...
  public function widget( $args ) {
    ...
    $content = do_shortcode('[snow_featured_content_sticky]');
